...
<div class="am-g">
    <div class="am-u-md-3">
        <form class="am-form am-inline" action="{{route('admin.audits.boss.approval',['id'=>$apply['id']])}}"
              method="post">
            {{csrf_field()}}
    ...
    <div class="am-u-md-6">
        <form class="am-form am-inline" action="{{route('admin.audits.boss.refusal',['id'=>$apply['id']])}}"
              method="post">
            {{csrf_field()}}
