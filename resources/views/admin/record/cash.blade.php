...
@section('content')
    <div class="lion-content-header am-cf">
        <h3 class="am-fl">现金记录</h3>
        <a href="" class="am-btn am-fr am-btn-sm am-btn-default"
           data-toggle='page'>刷新</a>
        <button type="button" data-am-modal="{target: '#modalcash-search'}"
                class="am-btn am-fr am-btn-primary am-btn-sm modal">搜索
        </button>
        <a href="{{route('admin.record.exportcash')}}" class="am-btn am-fr am-btn-sm am-btn-success modal" target="_blank">导出数据</a>
    </div>
...
<div class="am-modal am-modal-no-btn" tabindex="-1" id="modalcash-search">
