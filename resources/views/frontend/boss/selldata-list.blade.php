...
@section('content')
    ...
    <div class="user-center-menu-box">
        <a href="{{route('boss.totaldata.list')}}" class="user-center-menu"><i
                    class="icon icon-integralrecord introduce color-2d9cd8"></i>总体销售数据</a>
        <a href="{{route('boss.saledata.list')}}" class="user-center-menu"><i
                    class="icon icon-integrallift color-e7154a"></i>导购销售数据</a>
        <a href="{{route('boss.shopdata.list')}}" class="user-center-menu"><i
