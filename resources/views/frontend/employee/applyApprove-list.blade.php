...
@section('content')
    <div class="tab-nav">
        <a href="{{route('employee.applies.ajax',['type'=>\App\ShopStaffApply::STATUS_WAIT_FOT_PADDING])}}"
           data-auto-load
           data-ajax-list
           target="#tab-box"
        >待处理</a>
        <div class="line"></div>
        <a href="{{route('employee.applies.ajax',['type'=>30])}}" data-ajax-list target="#tab-box"
           class="active">已通过</a>
        <div class="line"></div>
