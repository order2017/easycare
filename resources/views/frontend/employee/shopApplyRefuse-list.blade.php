...
@section('content')
    <div class="tab-nav">
        ...
        <div class="line"></div>
        <a href="{{route('employee.shop-applies.ajax',['type'=>20])}}" data-ajax-list target="#tab-box" class="active">不通过</a>
    </div>
    <ul class="tab-list-box" data-ajax-load id="tab-box">
        @foreach($list as $line)
            <li>
                ...
                <a href="{{route('employee.shopApplyRefuse.page',['id'=>$line['id']])}}" class="list-btn">修改资料</a>
            </li>
        @endforeach
    </ul>
@endsection